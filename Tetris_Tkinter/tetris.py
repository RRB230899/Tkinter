...
img_obj1 = PhotoImage(file="img/tetris1.png")
sc.create_image(0, 0, anchor=NW, image=img_obj1)

img_obj2 = PhotoImage(file="img/tetris.png")
...
sc.create_text(500, 590,text="Score:", font=("WiGuru 2", 35),fill="white", anchor=NW)
_score = sc.create_text(542, 640,text=str(score), font=("WiGuru 2", 35),fill="gold", anchor=NW)
sc.create_text(480, 450,text="Record:", font=("WiGuru 2", 35),fill="white", anchor=NW)
_record = sc.create_text(522, 500,text=record, font=("WiGuru 2", 35),fill="gold", anchor=NW)
